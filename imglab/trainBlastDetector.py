...
training_xml_path = "blastTrain.xml" # os.path.join(faces_folder, "training.xml")
testing_xml_path = "blastTest.xml" # os.path.join(faces_folder, "testing.xml")
...
# dlib.
dlib.train_simple_object_detector(training_xml_path, "blastDetector.svm", options)
...
print("Training accuracy: {}".format(
    dlib.test_simple_object_detector(training_xml_path, "blastDetector.svm")))
# However, to get an idea if it really worked without overfitting we need to
# run it on images it wasn't trained on.  The next line does this.  Happily, we
# see that the object detector works perfectly on the testing images.
print("Testing accuracy: {}".format(
    dlib.test_simple_object_detector(testing_xml_path, "blastDetector.svm")))
