...
one_hot_labels = keras.utils.to_categorical(validation_generator, num_classes=3)

history = model.fit_generator(
    train_generator,
    steps_per_epoch=nb_train_samples // batch_size,
    epochs=epochs,
    validation_data=one_hot_labels,
...
model.save_weights('/home/katsuro/Documents/repo/precisionFarming/trainkmeansdata/s1_kmeans.h5')
