                   ...
                   private var isFragment: Boolean = false):RecyclerView.Adapter<UserAdapter.ViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserAdapter.ViewHolder {
        val view = LayoutInflater.from(mContext).inflate(R.layout.view_user_item_layout,parent, false)
    ...
    class ViewHolder(@NonNull itemView: View) :RecyclerView.ViewHolder(itemView){
        ...
        var userFullNameTextView:TextView = itemView.findViewById(R.id.user_full_name)
        var usernameTextView:TextView = itemView.findViewById(R.id.user_user_name)
        var userProfileImage:CircleImageView = itemView.findViewById(R.id.user_pic)
